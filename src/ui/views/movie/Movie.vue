  ...
  <article class="movie-detail">
    ...
    <b-container class="position-relative">
      ...
      <ul class="movie-detail__category-list d-flex justify-content-sm-start">
        <li><b-badge>sci-fi</b-badge></li>
        <li><b-badge>action</b-badge></li>
        <li><b-badge>warfare</b-badge></li>
      </ul>
      ...
      <section class="row">
        <div class="col-lg-6 d-flex">
          <img 
            src="https://image.tmdb.org/t/p/original/mnVZLdo9C4X80sJmgcGNpMNCbgk.jpg"
            alt="Mortal Kombat" 
            class="movie-detail__image"
          />
          <ul class="movie-detail__info">
            <li><span class="title">title:</span> Mad Max: Fury Road</li>
            <li><span class="title">release date:</span> 2015.03.19</li>
            <li><span class="title">original title:</span> Mad Max: Fury Road</li>
            <li><span class="title">original language:</span> English</li>
          </ul>
        </div>
        <div class="col-lg-6">
          <h2>Storyline</h2>
          <p>When the warrior Imperator Furiosa leads the despot's 
            five wives in a daring escape, she forges an alliance with 
            Max Rockatansky, a loner and former captive. Fortified in 
            the massive, armored truck the War Rig, they try to outrun 
            the ruthless warlord and his henchmen in a deadly 
            high-speed chase through the Wasteland.</p>
        </div>
      </section>
    </b-container>
  </article>
